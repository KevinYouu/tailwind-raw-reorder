...
### Removed
- `tailwind-raw-reorder-next.IgnoreConfigNotFound` setting
- `tailwind-raw-reorder-next.tailwindConfigPath` setting
...
* Forked from [heybourn/headwind] and rebranded as [Tailwind Raw Reorder Next] to provide modern maintenance and v4 support.
